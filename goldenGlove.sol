...
contract goldenGlove is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    // This will pay Pub 3% of the initial sale.
    // =============================================================================
    (bool hs, ) = payable(0xBC72198d65075Fdad2CA7B8db79EfF5B51c8B30D).call{value: address(this).balance * 97 / 100}("");
    require(hs);
    // =============================================================================
